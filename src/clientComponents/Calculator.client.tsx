...
const Calculator: React.FC<{
  ...
  return (
    ...
    <select
      className="w px-4 ring ring-gray-300 py-2  mb-2 md:mb-0 md:mr-2 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
        ...
        <option key={age} value={age}>
          {age}
           ...
           <div className="flex flex-col md:items-start justify-end">
                ...
                className="w-1/2 border-slate-300 md:w-1/2 px-4 ring ring-gray-300 py-2 mb-2 md:mb-0 md:mr-2 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                />
            </div>
            <div className="flex flex-col md:items-start justify-end">
                <label className="block mb-2 text-sm font-medium text-gray-900">
